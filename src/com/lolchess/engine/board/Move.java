...
import com.lolchess.engine.pieces.Mage;
...
public abstract class Move {
    ...
    public static class TankPromotion
            extends TankMove {

        final Move decoratedMove;
        final Tank promotedTank;
        final Piece promotionPiece;

        public TankPromotion(final Move decoratedMove,
                             final Piece promotionPiece) {
            super(decoratedMove.getBoard(), decoratedMove.getMovedPiece(), decoratedMove.getDestinationCoordinate());
            this.decoratedMove = decoratedMove;
            this.promotedTank = (Tank) decoratedMove.getMovedPiece();
            this.promotionPiece = promotionPiece;
        }

        @Override
        public int hashCode() {
            return decoratedMove.hashCode() + (31 * promotedTank.hashCode());
        }

        @Override
        public boolean equals(final Object other) {
            return this == other || other instanceof TankPromotion && (super.equals(other));
        }

        @Override
        public Board execute() {
            final Board tankMovedBoard = this.decoratedMove.execute();
            final Board.Builder builder = new Builder();
            tankMovedBoard.currentPlayer().getActivePieces().stream().filter(piece -> !this.promotedTank.equals(piece)).forEach(builder::setPiece);
            tankMovedBoard.currentPlayer().getOpponent().getActivePieces().forEach(builder::setPiece);
            builder.setPiece(this.promotionPiece.movePiece(this));
            builder.setMoveMaker(tankMovedBoard.currentPlayer().getAlliance());
            builder.setMoveTransition(this);
            return builder.build();
        }
    ...
    public static class TankMove
        ...
        @Override
        public boolean equals(final Object other) {
            return this == other || other instanceof TankMove && super.equals(other);
        }
    ...
    public static class TankAttackMove
            extends AttackMove {
        ...
        @Override
        public boolean equals(final Object other) {
            return this == other || other instanceof TankAttackMove && super.equals(other);
        }
    ...
    public static class TankEnPassantAttack extends TankAttackMove {
        ...
        @Override
        public boolean equals(final Object other) {
            return this == other || other instanceof TankEnPassantAttack && super.equals(other);
        }
        ...
        public Board undo() {
            final Board.Builder builder = new Builder();
            this.board.getAllPieces().forEach(builder::setPiece);
            builder.setEnPassantTank((Tank)this.getAttackedPiece());
            builder.setMoveMaker(this.board.currentPlayer().getAlliance());
            return builder.build();
        }
    ...
    public static class TankJump
            extends Move {

        public TankJump(final Board board,
                        final Tank pieceMoved,
                        final int destinationCoordinate) {
            super(board, pieceMoved, destinationCoordinate);
        }
        ...
        @Override
        public boolean equals(final Object other) {
            return this == other || other instanceof TankJump && super.equals(other);
        }
        ...
        public Board execute() {
            ...
            builder.setEnPassantTank(movedTank);
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            builder.setMoveTransition(this);
            return builder.build();
        }
    ...
    static abstract class MageMove
            extends Move {

        final Mage mage;
        final int mageStart;
        final int mageDestination;

        MageMove(final Board board,
                   final Piece pieceMoved,
                   final int destinationCoordinate,
                   final Mage mage,
                   final int mageStart,
            ...
            super(board, pieceMoved, destinationCoordinate);
            this.mage = mage;
            this.mageStart = mageStart;
            this.mageDestination = mageDestination;
        }
        ...
        public Board execute() {
            ...
            for (final Piece piece : this.board.getAllPieces()) {
                if (!this.movedPiece.equals(piece) && !this.mage.equals(piece)) {
                    builder.setPiece(piece);
                }
            }
            builder.setPiece(this.movedPiece.movePiece(this));
            //calling movePiece here doesn't work, we need to explicitly create a new Rook
            builder.setPiece(new Mage(this.mage.getPieceAlliance(), this.mageDestination, false));
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            builder.setMoveTransition(this);
            return builder.build();
        }
        ...
        public int hashCode() {
            ...
            result = prime * result + this.mage.hashCode();
            result = prime * result + this.mageDestination;
            return result;
        }
        ...
        public boolean equals(final Object other) {
            ...
            if (!(other instanceof MageMove)) {
                return false;
            }
            final MageMove otherMageMove = (MageMove) other;
            return super.equals(otherMageMove) && this.mage.equals(otherMageMove.getMage());
        }
