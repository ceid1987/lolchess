...
public class Combattant extends Piece {
    ...
    public Combattant movePiece(final Move move){
        return new Combattant(move.getDestinationCoordinate(), move.getMovedPiece().getPieceAlliance());
    }

    @Override
    public String toString() {
        return PieceType.COMBATTANT.toString();
    }
